...
contract ('Market', function (accounts){
  ...
  it("mint NFT toenId 1 to account[0]", function() {
        return NFT.deployed().then(function(instance) {
          NFTInstance = instance;
    
          return NFTInstance.Mint('My Crypto Collectable','description', accounts[0], 1, 'metadata', {from: accounts[0]});
        })
  });


  it("account[0] approves Auctioncontract ", function() {
    return NFT.deployed().then(function(instance) {
    NFTInstance = instance;
  ...
  it("account[1] can bid 3 ETH on auction] ", function() {
    return NFT.deployed().then(function(instance) {
      NFTInstance = instance;
      ...
      return Market.deployed();
        ...
        MarketInstance = instance;
        MarketInstance.Bid( {from: accounts[1], value: 4000000000000000000}); //3eth
  ...
  function sleep(seconds) 
{
  ...
  it("account[0] can end auction] ", function() {
    ...
    assert.equal(account, accounts[1], "The NFT is not owned by AUCTION contract.");
    }).then(function(res) {
